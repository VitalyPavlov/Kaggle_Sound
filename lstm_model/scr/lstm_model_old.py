...
def lstm_layers(inp_shape):
    ...
    #x = TCN(128, dilations=[1, 2, 4], return_sequences=True, activation='wavenet', name='tnc2')(x)
...
def lstm_model(train_index, y, y_encoded, noisy_index, y_encoded_noisy):
    ...
    ckpt = ModelCheckpoint('../data/weights_n.h5',
                           ...
                           mode='min')
    model.fit_generator(train_gen, epochs=5, verbose=1,
...
def fit():
    ...
    y_encoded_noisy = label_encoding(y_noisy)

    preds_val, y_val, loss, model = lstm_model(train_index, y, y_encoded, noisy_index, y_encoded_noisy)
